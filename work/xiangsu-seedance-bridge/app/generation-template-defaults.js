...
const layout={
 ...
 voice:'Preserve this character’s stable natural voice and visual identity. Speak only the supplied complete sample words once, with a clean onset and ending; no extra syllables, noises, captions or music. The sample is a voice reference, not a new story or the current production dialogue.',
