...
const TEXT_PROVIDER_CATALOG = Object.freeze({
  ...
  "minimax-native": {
    ...
    models: ["MiniMax-M2.1", "MiniMax-M2", "abab6.5s-chat"],
    temperature: 1,
    authSource: "user",
    domestic: true,
  ...
  "kimi-native": {
    ...
    models: ["kimi-k3", "kimi-k2.5", "moonshot-v1-128k"],
    temperature: 1,
  ...
  "doubao-native": {
    ...
    models: ["doubao-seed-1-6-250615", "doubao-1-5-pro-32k-250115", "doubao-lite-32k-240828"],
    temperature: 0.7,
    authSource: "user",
    domestic: true,
