...
contextBridge.exposeInMainWorld("dramaSlot", {
  ...
  workbench: {
    ...
    commitCommand: (projectId, commandType, payload, options) => ipcRenderer.invoke("workbench:commit-command", projectId, commandType, payload, options),
    promptChatCreateThread: request => ipcRenderer.invoke("workbench:prompt-chat-create-thread", request),
    promptChatSendTurn: request => ipcRenderer.invoke("workbench:prompt-chat-send", request),
    promptChatRead: request => ipcRenderer.invoke("workbench:prompt-chat-read", request),
    promptChatApply: request => ipcRenderer.invoke("workbench:prompt-chat-apply", request),
    promptChatCancel: request => ipcRenderer.invoke("workbench:prompt-chat-cancel", request),
    promptChatDiscard: request => ipcRenderer.invoke("workbench:prompt-chat-discard", request),
    getProductionSnapshot: projectId => ipcRenderer.invoke("workbench:production-snapshot", { projectId }),
