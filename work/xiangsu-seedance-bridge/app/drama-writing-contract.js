...
3. 每个10–15秒单元必须是一条因果动作链并按剧情安排必要的可见表演拍点，不固定数量：开场状态/入场或触发、对白中的有动机动作、听者闭口反应、对白造成的可见结果/离场或交接。起始状态、触发、关键变化、可见结果是因果核对维度，不要求各自形成一个拍点或子镜。动作必须改变信息、权力、物件或人物关系，不得添加无意义忙碌、机械手势或重复动作；不得为凑拍点添加无意义小动作，也不得为减少拍点删减必要事实。对白与兼容动作可以重叠。
