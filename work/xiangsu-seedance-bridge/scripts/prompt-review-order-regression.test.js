...
async function promptTranslationGenerator(_config, messages, opts) {
  ...
  if(op==='asset_execution_prompt'||op==='asset_visual_design'||op==='native_identity_cues'||op==='source_prop_inventory'||op==='film_runtime_director_plan'||/^h3_asset_direct_semantics_batch_/.test(op||'')){
